  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <MetaTags
          meta_title="Bankless | Polkadot pro začátečníky"
          meta_description="Pochopte teoretické základy Polkadot s našimi studijními články"
          og_title="Bankless | Polkadot pro začátečníky"
          og_image=""
          og_description="Pochopte teoretické základy Polkadot s našimi studijními články"
          twitter_title="Bankless | Polkadot pro začátečníky"
          twitter_image=""
          twitter_description="Pochopte teoretické základy Polkadot s našimi studijními články"
        />
