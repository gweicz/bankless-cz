  ...
  return (
    <>
      ...
      <div className="container" style={{ marginBottom: '50px' }}>
        ...
        <h3>Obsah stránek</h3>
        <p className="paragraph">Tato webová stránka může obsahovat technické nepřesnosti a typografické chyby. Všechen obsah, včetně těchto podmínek použití, může být postupem času upravován dle uvážení BanklessCZ. Před učiněním jakékoholiv rozhodnutí na základě obsahu této stránky si ověřte správnost, úplnost, přesnost a pravdivost informací. Majitel webových stránek neposkytuje záruku opravení případných chyb.</p>
